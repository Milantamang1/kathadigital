      ...
      <Section className="relative overflow-hidden py-12 md:py-16">
        ...
        <div className="grid items-start gap-8 lg:grid-cols-12 lg:gap-10">
          <div className="lg:col-span-7">
            <YouTubeEmbed id="QVfkQe29EKY" title="Katha Mero Pani" className="rounded-2xl" />
          </div>
          <div className="lg:col-span-5">
            ...
            <h2 className="font-display text-4xl font-light leading-tight md:text-5xl">
              {productions.kathaMeroPani.title}
            </h2>
            <p className="mt-4 leading-relaxed text-muted-foreground">
              Conversations with people whose journeys carry craft, courage, and perspective. The
              show is built around warm interviews, thoughtful pacing, and stories that stay with
              the audience after the episode ends.
            </p>
      ...
      <Section className="bg-ink/40 py-12 md:py-16">
        <div className="grid items-start gap-8 lg:grid-cols-12 lg:gap-10">
          ...
          <div className="lg:order-1 lg:col-span-7">
            ...
            <h2 className="font-display text-4xl font-light leading-tight md:text-5xl">
              {productions.gantavya.title}
            </h2>
            <p className="mt-4 max-w-2xl leading-relaxed text-muted-foreground">
              A travel-led series about place, food, culture, and the people who give a destination
              its voice. Each episode is designed to feel observant, personal, cinematic, and never
              rushed.
            </p>
