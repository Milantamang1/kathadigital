  ...
  return (
    <>
      <PageHero
        ...
        title={
          <>
            Book <em className="italic text-gold">Katha Digital</em>.
          </>
        }
...
function F({
  ...
  const cls =
    "w-full px-4 py-3 rounded-xl bg-background border border-border focus:border-gold outline-none text-sm transition-colors";
  return (
